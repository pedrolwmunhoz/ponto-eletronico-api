...
public interface AuditoriaSwagger {
    ...
    ResponseEntity<AuditoriaListagemResponse> listar(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "20") int size, @RequestHeader("Authorization") String authorization);
    ...
    ResponseEntity<AuditoriaDetalheResponse> detalhar(@PathVariable("logId") UUID logId, @RequestHeader("Authorization") String authorization);
}
